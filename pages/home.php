<section class="banner-container">
    ...
    <section class="descricao-autor">
        <div class="center">
            <div class="w50 left">
                <h2>Ivan T. Acioli</h2>
                <p>Desenvolvedor web formado em técnico em desenvolvimento de sistemas pelo ETE
                    Escola técnica Estadual, onde cursei as cadeiras de em lógica de programação,
                     git  estrutura de dados, banco de dados mysql, engenharia de software, metodologias
                      ágeis  desenvolvimento de aplicações web com html5, css3, javascript no front-end 
                      e php no back-end, tive uma cadeira de inglês técnico, mas no momento estou estudando 
                      intensivamente para melhorar meu inglês, já desenvolve varias projetos ques estão no 
                      meu repositório no github. Cotinuo me dedicando a essas tecnologias e ainda estou estudando,
                       java, nodejs sempre procurando me manter atualizado.
                </p>
    ...
    <section class="especialidades">
        <div class="center">
            ...
            <div class="w33 left box-especialidade">
                ...
                <h4>CSS3</h4>
                <p>CSS é uma linguagem de estilos usada para estilizar elementos de
                     uma página desenvolvida com uma linguagem de marcação, como 
                     o HTML. O que ela faz é separar a parte estrutural escrita, 
                     ou seja, o conteúdo, da parte visual, ou seja, o design gráfico 
                     dessa mesma página.
            ...
            <div class="w33 left box-especialidade">
                ...
                <p>HTML é uma das linguagens que utilizamos para desenvolver websites. 
                    ...
                    ou em português Linguagem de Marcação de Hipertexto.
            ...
            <div class="w33 left box-especialidade">
                ...
                <h4>JavasCript</h4>
                <p>Também conhecida apenas como JS, JavaScript é uma linguagem de programação usada para desenvolver aplicações, sistemas e serviços de alta complexidade.
            ...
            <div id="depoimentos" class="w50 left depoimentos-container">
                ...
                <div class="depoimento-singe">
                    <p class="depoimento-descricao">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Id nesciunt assumenda nisi eos, voluptatum explicabo
                        illum quaerat earum accusantium tempora fuga debitis deserunt
                        quaerat earum accusantium tempora fuga debitis deserunt
                    </p>
                    <p class="nome-autor">Lorem ipsom</p>
                </div>
                <!--depoimento-single-->
                <div class="depoimento-singe">
                    <p class="depoimento-descricao">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                ...
                <div class="servicos">
                    <ul>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            ...
                            Id nesciunt assumenda nisi eos, voluptatum explicabo
                            illum quaerat earum accusantium tempora fuga debitis deserunt</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Id nesciunt assumenda nisi eos, voluptatum explicabo
                            illum quaerat earum accusantium tempora fuga debitis deserunt
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
